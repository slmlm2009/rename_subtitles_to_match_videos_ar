...
def analyze_files():
    ...
    for filename in all_files:
        ...
        formatted_output = f"S{season_display}E{episode_display}"
    ...
    with open(csv_path, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ['filename', 'type', 'episode_string', 'season', 'episode', 'formatted_output']
    ...
    for result in results:
        ...
        print(f\"{filename} >> {formatted_output}\")
