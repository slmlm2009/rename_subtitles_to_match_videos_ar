...
def debug_pattern_matching(filename):
    print(\"Debugging pattern matching for: \" + filename)
    
    # Pattern 1: S##E##
    pattern = r'[Ss](\\d+)[Ee](\\d+)'
    match = re.search(pattern, filename)
    if match:
        print(\"  1. S##E## matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename)
    if match:
        print(\"  2. 2x05 matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    if match:
        print(\"  3. Season.Episode matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\"  4. S##.Ep.## matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\"  5. Season X Episode Y matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\"  6. ShowNameSeasonXEpisodeY matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\"  7. ShowNameSeasonX EpisodeY matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename)
    if match:
        print(\"  8. E#### matched: \" + match.group(0))
        return \"S01E\" + match.group(1)
    else:
        print(\"  8. E####: no match\")
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\"  9. Ep#### matched: \" + match.group(0))
        return \"S01E\" + match.group(1)
    else:
        print(\"  9. Ep####: no match\")
    ...
    match = re.search(pattern, filename, re.IGNORECASE)
    if match:
        print(\" 10. S##Ep## matched: \" + match.group(0))
        return \"S\" + match.group(1).zfill(2) + \"E\" + match.group(2)
    else:
    ...
    match = re.search(pattern, filename)
    if match:
        print(\" 11. - ## matched: \" + match.group(0))
        return \"S01E\" + match.group(1)
    else:
        print(\" 11. - ##: no match\")
