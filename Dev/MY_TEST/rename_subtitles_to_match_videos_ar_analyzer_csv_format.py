...
def get_episode_number(filename):
    ...
    if match:
        episode_num = match.group(1)  # Keep original episode digits
...
def analyze_files():
    ...
    for filename in all_files:
        ...
        # For subtitle files, check if the episode pattern might match a video file with different padding
        ...
        if filename in subtitle_files and episode_string:
            ...
            if season and episode:
                ...
                if key in video_episodes:
                    ...
                    print(f"Context adjustment: {filename} has {episode_string} but video has {video_pattern}")
        ...
        print("File: " + filename + " | Type: " + file_type + " | Episode String: " + (adjusted_episode_string or 'None') + " | Season: " + (season or 'N/A') + " | Episode: " + (episode or 'N/A'))
